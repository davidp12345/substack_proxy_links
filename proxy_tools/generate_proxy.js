...
=======
>>>>>>> 5ffabf9e4acf3034de42fa2ec6957e90bdc6cccc
...
function normalizeUrl(url) {
  // Remove protocol and www, replace special characters with hyphens
  return url
    .replace(/^https?:\/\//, '')
    .replace(/^www\./, '')
    .replace(/[^a-zA-Z0-9]/g, '-')
...
function main() {
  ...
  console.log(`✅ Proxy created: ${filename}`);
...
module.exports = { normalizeUrl, generateProxyHtml };
>>>>>>> 5ffabf9e4acf3034de42fa2ec6957e90bdc6cccc
